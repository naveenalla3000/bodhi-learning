      ...
      <div className="max-w-7xl mx-auto px-16">
        ...
        <div className="space-y-4">
          {milestones.map((m) => (
            <div
              key={m.year}
              className="airy-card relative flex items-center gap-12 p-8 rounded-2xl bg-surface"
            >
              {m.featured && (
              ...
              <div className="text-3xl font-montserrat text-primary/30 font-bold w-20 flex-shrink-0">
                {m.year}
              </div>
              <div>
